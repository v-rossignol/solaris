...
const RELOCATE_ERROR_FALLBACKS: Record<number, string> = {
  ...
  403: 'You are not allowed to travel to this star system.',
  404: 'This star system was not found.',
  409: 'You cannot travel there from your current location.',
};

const DEFAULT_RELOCATE_ERROR = 'Failed to relocate to this star system.';
